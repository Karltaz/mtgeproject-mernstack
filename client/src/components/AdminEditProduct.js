                ...
                <div className="row">
                    <div className="col-md-8 mx-auto">
                        <Link to="/admin/dashboard">
                            <span className="fas fa-arrow-left my-4">  Go Back </span>
                        </Link>
                        <br />
                                     ...
                                     <div className="modal-body my-2">
                                        <Fragment>
                                            ...
                                            <div className="form-group">
                                                <label className="text-secondary my-2">Name</label>
                                                <input
                                                type="text"
                                            ...
                                            <div className="form-group">
                                                <label className='text-secondary my-2'>Description</label>
                                                <textarea
                                                className='form-control' 
                                                rows="3"
                                                name="productDesc"
                                            ...
                                            <div className="form-group">
                                                <label  className="text-secondary my-2">Price</label>
                                                <input
                                                type="text"
                                                className='form-control'
                                                name="productPrice"
